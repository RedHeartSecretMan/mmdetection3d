_base_ = ["../_base_/schedules/mmdet-schedule-1x.py", "../_base_/default_runtime.py"]
...
model = dict(
    ...
    neck_3d=dict(
        type="IndoorImVoxelNeck", in_channels=256, out_channels=128, n_blocks=[1, 1, 1]
    ),
    bbox_head=dict(
        type="ImVoxelHead",
        n_classes=10,
...
val_evaluator = dict(
    type="IndoorMetric", ann_file=data_root + "sunrgbd_infos_val.pkl", metric="bbox"
)
