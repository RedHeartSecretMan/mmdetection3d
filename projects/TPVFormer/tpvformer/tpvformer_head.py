...
class TPVFormerDecoder(BaseModule):
    ...
    def predict(self, tpv_list, batch_data_samples):
        ...
        for i, data_sample in enumerate(batch_data_samples):
            ...
            point_coors[..., 0] = (
                point_coors[..., 0] / (self.tpv_w * self.scale_w) * 2 - 1
            )
            point_coors[..., 1] = (
                point_coors[..., 1] / (self.tpv_h * self.scale_h) * 2 - 1
            )
            point_coors[..., 2] = (
                point_coors[..., 2] / (self.tpv_z * self.scale_z) * 2 - 1
            )
    ...
    def loss(self, tpv_list, batch_data_samples):
        ...
        for i, data_sample in enumerate(batch_data_samples):
            ...
            fused_pts = (tpv_hw_pts + tpv_zh_pts + tpv_wz_pts).squeeze(0).squeeze(1)
        ...
        logits = self.decoder(torch.cat([batch_pts, batch_vox], dim=1).transpose(0, 1))
