...
class TransFusionHead(nn.Module):
    ...
    def forward_single(self, inputs, metas):
        ...
        fusion_feat_flatten = fusion_feat.view(
            batch_size, fusion_feat.shape[1], -1
        )  # [BS, C, H*W]
    ...
    def predict_by_feat(
        self, preds_dicts, metas, img=None, rescale=False, for_roi=False
    ):
    ...
    def get_targets(
        self, batch_gt_instances_3d: List[InstanceData], preds_dict: List[dict]
    ):
