...
class MSDeformAttn(nn.Module):
    ...
    def __init__(
        ...
        self.sampling_offsets = nn.Linear(dim_model, n_heads * n_levels * n_points * 2)
        self.attention_weights = nn.Linear(dim_model, n_heads * n_levels * n_points)
    ...
    def forward(
        ...
        if reference_points.shape[-1] == 2:
            ...
            raise ValueError(
                "Last dim of reference_points must be 2 or 4, but get {} instead.".format(  # noqa: E501
